  ...
  <div class="w-full py-4 md:px-4 bg-black">
    ...
    <div class="w-full space-y-4 py-4 text-center">
      ...
      <p class="text-white font-poppins">
        Ce que pensent les membres de la Formation FBWA
      </p>

      <a
        href="https://wa.me/+237697185754"
        class="inline-block mt-4 bg-gradient-to-b to-black/60 from-[#E30065] text-white font-bold py-2 px-4 rounded-tl-2xl rounded-br-2xl"
        target="_blank"
      >
    ...
    <transition name="fadezoom">
      ...
      >
        ...
        <!-- prev -->
        <button class="absolute left-4 text-white text-4xl" @click="prevImage">
          ‹
        </button>
        ...
        <!-- next -->
        <button class="absolute right-4 text-white text-4xl" @click="nextImage">
          ›
        </button>
      </div>
    </transition>
